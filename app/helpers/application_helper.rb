module ApplicationHelper
  ...
  def sortable(column, title = nil)
    ...
    link_to title, params.permit(:status, :sort, :direction, :search, :last_name, :first_name, :record_id, :email, :assignment_status, :registration_status).merge({ sort: column, direction: direction }), { class: css_class }
  end
