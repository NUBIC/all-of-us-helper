class HealthPro < ApplicationRecord
  ...
  HEALTH_PRO_API_GENERAL_CONSENT_STATUSES = [HEALTH_PRO_API_GENERAL_CONSENT_STATUS_UNSET, HEALTH_PRO_API_GENERAL_CONSENT_STATUS_SUBMITTED, HEALTH_PRO_API_GENERAL_CONSENT_STATUS_SUBMITTED_NO_CONSENT, HEALTH_PRO_API_GENERAL_CONSENT_STATUS_SUBMITTED_NOT_SURE, HEALTH_PRO_API_GENERAL_CONSENT_STATUS_SUBMITTED_INVALID]
  HEALTH_PRO_API_GENERAL_CONSENT_STATUSES_DECLINED = [HEALTH_PRO_API_GENERAL_CONSENT_STATUS_SUBMITTED_NO_CONSENT, HEALTH_PRO_API_GENERAL_CONSENT_STATUS_SUBMITTED_NOT_SURE, HEALTH_PRO_API_GENERAL_CONSENT_STATUS_SUBMITTED_INVALID]
  ...
  HEALTH_PRO_API_EHR_CONSENT_STATUSES = [HEALTH_PRO_API_EHR_CONSENT_STATUS_UNSET, HEALTH_PRO_API_EHR_CONSENT_STATUS_SUBMITTED, HEALTH_PRO_API_EHR_CONSENT_STATUS_SUBMITTED_NO_CONSENT, HEALTH_PRO_API_EHR_CONSENT_STATUS_SUBMITTED_NOT_SURE, HEALTH_PRO_API_EHR_CONSENT_STATUS_SUBMITTED_INVALID]
  HEALTH_PRO_API_EHR_CONSENT_STATUSES_DECLINED = [HEALTH_PRO_API_EHR_CONSENT_STATUS_SUBMITTED_NO_CONSENT, HEALTH_PRO_API_EHR_CONSENT_STATUS_SUBMITTED_NOT_SURE, HEALTH_PRO_API_EHR_CONSENT_STATUS_SUBMITTED_INVALID]
  ...
  HEALTH_PRO_API_DEACTIVATION_STATUSES = [HEALTH_PRO_API_DEACTIVATION_STATUS_NOT_SUSPENDED, HEALTH_PRO_API_DEACTIVATION_STATUS_NO_CONTACT]
