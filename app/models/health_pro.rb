class HealthPro < ApplicationRecord
  ...
  HEALTH_PRO_RACE_ETHNICITY_HLS_AND_MORE_THAN_ONE_OTHER_RACE  = 'HLS and more than one other race'
  ...
  HEALTH_PRO_RACE_ETHNICITY_HLS_AND_WHITE = 'HLS and White'
  HEALTH_PRO_RACE_ETHNICITY_AMERICAN_INDIAN_ALASKA_NATIVE = 'American Indian / Alaska Native'
  HEALTH_PRO_RACE_ETHNICITY_HLS_AND_BLACK = 'HLS and Black'
  HEALTH_PRO_RACE_ETHNICITY_PREFER_NOT_TO_ANSWER = 'Prefer Not to Answer'
  HEALTH_PRO_RACE_ETHNICITY_HLS_AND_ONE_OTHER_RACE  = 'HLS and One Other Race'
  HEALTH_PRO_RACE_ETHNICITY_MORE_THAN_ONE_RACE = 'More than one race'
  HEALTH_PRO_RACE_ETHNICITY_OTHER = 'Other'
  HEALTH_PRO_RACE_ETHNICITY_NATIVE_HAWAIIAN_OTHER_PACIFIC_ISLANDER = 'Native Hawaiian/Other Pacific Islander'
