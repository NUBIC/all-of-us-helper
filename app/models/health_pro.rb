class HealthPro < ApplicationRecord
  ...
  BIOSPECIMEN_LOCATIONS = [BIOSPECIMEN_LOCATION_NORTHWESTERN, BIOSPECIMEN_LOCATION_NORTHWESTERN_DELNOR]
  ...
  HEALTH_PRO_PARTICIPANT_STATUS_FULL_PARTICIPANT = 'Full Participant'
