Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "all-of-us-helper_#{Rails.env}"
  ...
  config.middleware.use ExceptionNotification::Rack,
    ...
    config.all_of_us_helper_api_users = ActiveSupport::HashWithIndifferentAccess.new(YAML.load_file('/opt/nubic/all_of_us_helper_api_users.yml'))
