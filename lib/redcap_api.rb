 ...
 "#{record_id}","#{st_event}","#{st_event_d}","#{st_import_d}"),
  ...
  "#{record_id}","#{pmi_id}","#{consent}","#{consent_d}","#{ehr_consent}","#{ehr_consent_d}","#{map_withdrawn_y(withdrawn_y)}","#{withdrawal_d}","1","#{wq_participant_status}","#{pm_date}","#{wq_paired_site}","#{wq_paired_org}","#{health_pro_email}","#{health_pro_phone}","#{health_pro_login_phone}","#{gror_consent}","#{gror_consent_d}","#{core_participant_d}","#{map_deactivation_status(deactivation_status)}","#{deactivation_date}","#{map_required_ppi_complete_y(required_ppi_complete_y)}","#{completed_surveys}","#{map_y_column(basics_ppi_complete_y)}","#{ basics_ppi_complete_d}","#{map_y_column(health_ppi_complete_y)}","#{health_ppi_complete_d}","#{map_y_column(lifestyle_ppi_complete_y)}","#{lifestyle_ppi_complete_d}","#{map_y_column(history_ppi_complete_y)}","#{history_ppi_complete_d}","#{map_y_column(meds_ppi_complete_y)}","#{meds_ppi_complete_d}","#{map_y_column(family_ppi_complete_y)}","#{family_ppi_complete_d}","#{map_y_column(access_ppi_complete_y)}","#{access_ppi_complete_d}","#{map_y_column(copemay_complete_y)}","#{copemay_complete_d}","#{map_y_column(copejune_complete_y)}","#{copejune_complete_d}","#{map_y_column(copejuly_complete_y)}","#{copejuly_complete_d}","#{first_primary_consent_d}","#{first_ehr_consent_d}","#{health_pro_address1}","#{health_pro_address2}","#{health_pro_city}","#{health_pro_state}","#{health_pro_zip}","#{wq_program_update_status}","#{wq_program_update_date}"),
    ...
    payload = {
        ...
        :type => 'flat',
        :overwriteBehavior => 'overwrite',
        :data => %(record_id,pmi_id,consent,consent_d,ehr_consent,ehr_consent_d,withdrawn_y,withdrawal_d,wq_participant_status,pm_date,wq_paired_site,wq_paired_org,health_pro_email,health_pro_phone,health_pro_login_phone,gror_consent,gror_consent_d,core_participant_d,deactivation_status,deactivation_date,required_ppi_complete_y,completed_surveys,basics_ppi_complete_y,basics_ppi_complete_d,health_ppi_complete_y,health_ppi_complete_d,lifestyle_ppi_complete_y,lifestyle_ppi_complete_d,history_ppi_complete_y,history_ppi_complete_d,meds_ppi_complete_y,meds_ppi_complete_d,family_ppi_complete_y,family_ppi_complete_d,access_ppi_complete_y,access_ppi_complete_d,copemay_complete_y,copemay_complete_d,copejune_complete_y,copejune_complete_d,copejuly_complete_y,copejuly_complete_d,first_primary_consent_d,first_ehr_consent_d,health_pro_address1,health_pro_address2,health_pro_city,health_pro_state,health_pro_zip,wq_program_update_status,wq_program_update_date,donotcontact
  ...
  "#{record_id}","#{first_name}","#{last_name}","#{email}","#{phone_1}","4","#{pmi_id}","1","2","#{consent}","#{consent_d}","#{ehr_consent}","#{ehr_consent_d}","#{ts}","#{map_withdrawn_y(withdrawn_y)}","#{withdrawal_d}","1",#{wq_participant_status},#{pm_date},#{wq_paired_site},#{wq_paired_org},#{health_pro_email},#{health_pro_phone},#{health_pro_login_phone},"#{gror_consent}","#{gror_consent_d}","#{core_participant_d}","#{map_deactivation_status(deactivation_status)}","#{deactivation_date}","#{map_required_ppi_complete_y(required_ppi_complete_y)}","#{completed_surveys}","#{map_y_column(basics_ppi_complete_y)}","#{basics_ppi_complete_d}","#{map_y_column(health_ppi_complete_y)}","#{health_ppi_complete_d}","#{map_y_column(lifestyle_ppi_complete_y)}","#{lifestyle_ppi_complete_d}","#{map_y_column(history_ppi_complete_y)}","#{history_ppi_complete_d}","#{map_y_column(meds_ppi_complete_y)}","#{meds_ppi_complete_d}","#{map_y_column(family_ppi_complete_y)}","#{family_ppi_complete_d}","#{map_y_column(access_ppi_complete_y)}","#{access_ppi_complete_d}","#{map_y_column(copemay_complete_y)}","#{copemay_complete_d}","#{map_y_column(copejune_complete_y)}","#{copejune_complete_d}","#{map_y_column(copejuly_complete_y)}","#{copejuly_complete_d}","#{site_preference___1}","#{site_preference___2}","#{site_preference___3}","#{site_preference___4}","2","#{first_primary_consent_d}","#{first_ehr_consent_d}","#{health_pro_address1}","#{health_pro_address2}","#{health_pro_city}","#{health_pro_state}","#{health_pro_zip}","#{wq_program_update_status}","#{wq_program_update_date}"),
        :returnContent => 'ids',
        :returnFormat => 'json'
    }
    else
